...
class ProductFactory extends Factory
{
    ...
    public function definition()
    {
        return [
            ...
            'created_at' => $this->faker->dateTimeThisMonth(), // Generate a random date within the current month
            'updated_at' => $this->faker->dateTimeThisMonth(), // Generate a random date within the current month
